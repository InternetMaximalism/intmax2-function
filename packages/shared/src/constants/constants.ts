...
export const FIRESTORE_DOCUMENT_EVENTS = {
  ...
  MINTER: "minter",
  BRIDGE_REQUESTED: "bridgeRequested",
} as const;
...
export const BASE_BRIDGE_O_APP_CONTRACT_ADDRESS =
  config.BASE_BRIDGE_O_APP_CONTRACT_ADDRESS as `0x${string}`;
export const BASE_BRIDGE_O_APP_CONTRACT_DEPLOYED_BLOCK =
  config.BASE_BRIDGE_O_APP_CONTRACT_DEPLOYED_BLOCK;
export const MAINNET_BRIDGE_O_APP_CONTRACT_ADDRESS =
  config.MAINNET_BRIDGE_O_APP_CONTRACT_ADDRESS as `0x${string}`;
...
// block event
export const BLOCK_RANGE_TINY = 499n;
